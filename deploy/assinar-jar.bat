...
jarsigner -keystore "../keystore/assistente.jks" -storepass Arcom10$ -keypass Arcom10$  ../target/lib/javafx-base-13-win.jar assistente
jarsigner -keystore "../keystore/assistente.jks" -storepass Arcom10$ -keypass Arcom10$  ../target/lib/javafx-base-13.jar assistente
jarsigner -keystore "../keystore/assistente.jks" -storepass Arcom10$ -keypass Arcom10$  ../target/lib/javafx-controls-13-win.jar assistente
...
jarsigner -keystore "../keystore/assistente.jks" -storepass Arcom10$ -keypass Arcom10$  ../target/lib/javafx-fxml-13-win.jar assistente
jarsigner -keystore "../keystore/assistente.jks" -storepass Arcom10$ -keypass Arcom10$  ../target/lib/javafx-fxml-13.jar assistente
jarsigner -keystore "../keystore/assistente.jks" -storepass Arcom10$ -keypass Arcom10$  ../target/lib/javafx-graphics-13-win.jar assistente
